...
public class CourseContentController {
    ...
    public ResponseEntity<List<CourseContentResponse>> findAllCourseContentByCourseId(@PathVariable("courseId") Long courseId) {
        ...
        for (CourseContentResponse ccr : findAllCourseContentByCourseId) {
            ccr.setVideoResponses(videoResponseDTOMapper.toDto(videoManagementService.getFileById(ccr.getId())));
        }
